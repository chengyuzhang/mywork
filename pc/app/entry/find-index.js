    ...
    $.ajax({
        ...
        success:function(data){
            data.body.subjects.forEach(function(item,index){
                ...
                // str+='</li>';
                str+=`<div class="swiper-slide" style="background-image:url(${item.cover})"><p>${item.title}</p><a href="${item.link}"></a></div>`;
            });
            oWrap.html(str);
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            aLabel.forEach(function(item,index){
                if(index==0){
                    sLabel+='<li id="'+item.id+'" class="swiper-slide" data-kind="story"><a href="javascript:;">'+item.labelContent+'</a></li>';
                }else if(index==1){
                    sLabel+='<li id="'+item.id+'" class="swiper-slide" data-kind="fashion"><a href="javascript:;">'+item.labelContent+'</a></li>';
                }else if(index==2){
                    sLabel+='<li id="'+item.id+'" class="swiper-slide" data-kind="beauty"><a href="javascript:;">'+item.labelContent+'</a></li>';
                }
        ...
        success:function(data){
            ...
            data.articles.forEach(function(item,index){
                ...
                str+=`<li class='list-item'>
                        <div class='item-pic'>
                            <a href="find-details.html?id=${item.id}"><img data-src=${item.cover}></a>
                        </div>
