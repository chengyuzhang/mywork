	        ...
	        switch(iCode){
	        	case 10://已下单
	        		str+=`<div class="status">
	                    ...
	                    <p class="contact"><a href="jump.html" target="_blank">联系客服</a> <b data-type="cancel" class="s cancel-order">取消订单</b></p>`;
	        	break;
				case 20://已付款
	        		//$('.pay-detail>ul>li.need-pay>span').text('实付款：');
	        		str+=`<div class="status">
	                    ...
	                    <p class="contact"><a href="jump.html" target="_blank">联系客服</a> <b data-type="rerund" class="refund">申请退款</b></p>`;
	        	break;
				case 21://已取消
	        		...
	        		str+=`<div class="status">
	                    ...
	                    <p class="contact"><a href="jump.html" target="_blank">联系客服</a><b data-type="delete" class="s active delete-order">删除订单</b></p>`;
				...
				case 30://已发货
	        		str+=`<div class="status">
	                    ...
	                    <p class="contact"><a href="jump.html" target="_blank">联系客服</a></p>`;
	        		//$('.pay-detail>ul>li.need-pay>span').text('实付款：');
	        	break;
				case 40://交易成功
	        		...
	        		str+=`<div class="status">
	                    ...
	                    <p class="contact"><a href="jump.html" target="_blank">联系客服</a> <b data-type="support" class="server-support">申请售后</b><b data-type="cancel" class="s active delete-order">删除订单</b></p>`;
	        	break;
				case 60://售后处理中
	        		//str+=`<a href="javascript:;" class="s active" >联系客服</a>`;
	        		//$('.pay-detail>ul>li.need-pay>span').text('实付款：');
	        		str+=`<h2>售后处理中</h2>
	                        <a href="jump.html" target="_blank">联系客服</a>`;
	                        $(oCon).css('width','100%');
