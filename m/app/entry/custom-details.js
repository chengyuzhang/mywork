		...
		success:function(data){
	        ...
	        switch(iCode){
	        	case 10://已下单
		              ...
		              <p>如果没有收到货，或受到货后出现问题，您可以联系客服协商解决</p>
		              <p><button class="sure-btn active pay-money">立即付款</button><button class=""><a href="jump.html" target="_blank">联系客服</a></button></p>`;
	        	break;
				case 20://已付款
	        		str+=`<h4>您已成功提交订单，商品正在准备中</h4>
		              <p>如果没有收到货，或受到货后出现问题，您可以联系客服协商解决</p>
		              <p><button class="sure-btn refund-btn refund" data-type="refund">申请退款</button><button class=""><a href="jump.html" target="_blank">联系客服</a></button></p>`;
	        	break;
				case 21://已关闭
	        		str+=`<h4></h4>
		              <p></p>
		              <p><button class="sure-btn refund-btn">已关闭</button><button class=""><a href="jump.html" target="_blank">联系客服</a></button></p>`;
	        	break;
				
				case 60://售后处理中
	        		       str+=`<h4>待发货</h4>
		              <p></p>
		              <p><a href="jump.html" target="_blank">联系客服</a></button></p>`;
				...
				case 70://已发货
	        		 str+=`<h4>您已成功提交订单，商品正在准备中</h4>
		              <p>如果没有收到货，或受到货后出现问题，您可以联系客服协商解决</p>
		              <p><button class="sure-btn custom-ok" data-type="ok">确认收货</button><button class=""><a href="jump.html" target="_blank">联系客服</a></button></p>`;
				...
				case 41://待退款
	        		...
	        		str+=`<h4>待退款</h4>
		              <p></p>
		              <p><button class=""><a href="jump.html" target="_blank">联系客服</a></button></p>`;
