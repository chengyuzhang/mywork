    ...
    $.ajax({
        ...
        success:function(data){
            ...
            data.carousels.forEach(function(item,index){
                sLoop+=`<div class="swiper-slide" data-id=${item.id}><img data-src=${item.mainPicture} alt=""><a href="series-topic.html?id=${item.id}"></a></div>`;
            });
            ...
            data.topicBody.forEach(function(item0,index){
                if(index==0){
                    $('.new-goods a').attr('href','topic-list.html?id='+item0.topic.id);
                }else if(index>=1){
                    sKind+=`<div class="gife-born">`;         
                    sKind+='<h2><img src="" data-src="'+require('../imgs/pic-title'+index+'.png')+'" alt=""></h2>';
                    sKind+=`<div class="pic-baby1"><img src="" data-src=${item0.topic.mainPicture} alt=""><a href="series-topic.html?id=${item0.topic.id}"></a></div><ul>`;
                            if(item0.item){
                                ...
                                sKind+=`<li>
                                        ...
                                        <h4>${item1.title}</h4>
                                        <p>${item1.subTitle}</p>
                                        <a href="product-details.html?id=${item1.goodsId}"></a>
                                    </li>`;
                                });
                            }
